...
### ¿Afecta la estación al número de visualizaciones y calificaciones que hacen los usuarios?
...
```
Se observa en el gráfico que la distribución de las calificaciones por meses está relativamente compensada siendo octubre el mes en el cual se calificaron más películas con un 10% del total de votaciones, le sigue el mes de septiembre con un 9.9% y noviembre con un 8.9%. El mes de enero es el mes en el que se realizaron el menor número de calificaciones (6.8% del total).
...
Además, podemos deducir que con ciertas festividades, como puede ser Halloween celebrada a finales de octubre, se pueden incrementar el número de visualizaciones y calificaciones ya que los usuarios tienden a ver películas de esta temática. En nuestro caso, el mes de octubre se encuentran varias películas clasificadas con el género de terror como: *Destino Final*, *Eaten Alive*, *Proteus* o *Killing Zoe*, entre otras.
...
La distribución de votaciones por años se estudiará en relación a las 10 películas más votadas: `r movies_title[10,1]`. El rango de años estudiado es desde el 1999 hasta el 2005.
...
Inicialmente se observa que de las películas más votadas, solo 3 de ellas (*Good Morning vietnam*, *Lethal Weapon 3* y *Meet Joe Black*) tuvieron alguna puntuación en el 1999. Al año siguiente empezaron a calificarse 2 películas más (*Bad Boys* y *Final Destination*), en 2001 se sumó la película *Some Like It Hot*, y un año después las películas *The Rundown* y *Freaky Friday*. Seguidamente en 2003 comenzó a recibir calificaciones la película *The Grudge* y, finalmente, en 2004 empezó a ser calificada la película *Monster-in-Law*.

La cantidad de calificaciones fue aumentando cada año hasta situarse el 2005 como el año en el cual todas las películas recibieron más calificaciones con excepción de 2 casos: *Freaky Friday* y *The Rundown* las cuales recibieron la mayor cantidad en el año 2004 con un total de 43.612 y 25.056 votos respectivamente.
...
Al igual que en el gráfico anterior, se observa que no todas las películas tienen votaciones en años más anteriores como el 1999, 2000 o 2001. Vemos que en todas las películas la media de la puntuación por año siempre se encuentra entre las 3 y 4 estrellas. Casos con excepciones podría ser *The Grudge*, que en el 2005 tiene una media por debajo de 2.99 estrellas. 

*Good Morning, Vietnam* comenzó a ser calificada desde 1999 y su calificación ha ido evolucionando positivamente y siempre por encima de la media de calificaciones totales y, alcanzado su mayor puntuación en el año 2004 con una media de 3.90 estrellas.

*Lethal Weapon 3* y *Meet Joe Black* también recibieron calificaciones durante este periodo de tiempo estando esta cercana a la media y, obteniendo la mayor calificación en el año 2005 con una puntuación igual a 3.93 en el caso de la primera película y en 2004 la segunda película con un total de 3.61 estrellas. 

*Bad Boys* y *Final Destination* comenzaron a ser calificadas a partir del año 2000 siendo su calificación inferior a la media los 3 y 4 años respectivamente y en los siguientes años esta comenzó a estar por encima. La calificación máxima la alcanzaron ambas en el año 2005 y la calificación fue de 3.77 y 3.54 respectivamente.

*Some Like It Hot* se empezó a calificar en el año 2001 siendo cada puntuación media anual superior a la media total del estudio, siempre por encima del 3.99 y alcanzando la puntuación máxima en 2001 con una puntuación de 3.99.

*Freaky Friday* y *The Rundown* recibieron las primeras calificaciones en el año 2003. La puntuación más alta de ambas se dio este mismo año con un total de 3.88 estrellas en ambas películas.

Un año después empezó a recibir votaciones la película The Grudge con su máxima calificación en el año 2004 de 3.62 estrellas, calificación que decreció un año después.

El último año con el que contamos, 2005, empezó a recibir calificaciones la película Monster-in-Law, que recibió un total de 3.43 estrellas.

Analizando estos gráficos podemos llegar a algunas conclusiones como:

La película más calificada, lo que quiere decir que es más probable que sea la mas vista, no tiene porque ser la mejor. Pues, en el caso de “Good Morining, Vietnam” esta fue la más votada pero no fue la que recibió la mejor calificación. De estas 10 películas, más votadas, por ejemplo, podemos decir que “Some Like It Hot” a pesar de ser una película menos votada que “Good Morning, Vietnam” es considerada mejor película por los usuarios pues su media siempre es superior a 3.9 estrellas.

A destacar también las puntuaciones de *Freaky Friday* que con el paso de los años va bajando su media, cuando otras como *Lethal Weapon 3*, *Bad Boys* o *Final destination* pasan por el caso contrario, donde su media de califación va aumentando. La película *Some Like It Hot* mantiene una media muy alta rozando casi las 4 estrellas y con una distribución muy estable durante todos los años, casi sin variación en su media.


## **Comparación entre películas**

A continuación se compararán y analizarán los datos de diferentes películas del dataset.
...
* Media de las valoraciones en estrellas
* Desviación estándar (std)
* Calificación/valoración mínima en estrellas (min)
* Calificación/valoración mínima en estrellas (max)
* Calificación/valoración del 25% de las observaciones (25%)
* Calificación/valoración del 50% de las observaciones (50%)
* Calificación/valoración del 75% de las observaciones (75%)
* La moda de las calificaciones (mode)
* La mediana de las calificaciones (median)
...
Las cinco películas que más fueron clasificadas por los usuarios fueron: *Good morning, Vietnam* con una puntuación media de 3.85 estrellas, *Lethal Weapon 3* con 3.81 estrellas, *Bad boys* con 3.72 estrellas, *Freaky Friday*”* con una media de 3.55 y finalmente *Final Destination* con un 3.49 estrellas. Todas las películas, excepto las dos últimas, superan la puntuación media de todas las películas de este estudio, siendo esta de 3.56 estrellas.

En las dos primeras películas la mayoría de las calificaciones son de 3, 4 y 5 estrellas, mientras que en el resto de las películas predomina la puntuación de 3 y 4 estrellas.



### ¿Cuál es la distribución de calificación de la película más votada?
...
### ¿Cuál es la distribución de calificación de la película menos votada?
...
Han sido en las últimas dos décadas, que figuran en nuestro estudio, donde se han dado la mayoría de las calificaciones, concretamente un 50% del total. En general, se puede concluir que cuanto más moderna es la película más votaciones tiene, puesto que la gente prefiere visualizar producciones más actuales que antiguas. Esto también puede darse por el catálogo de Netflix, que dispone de películas más actuales. 


### ¿Afecta el año de estreno a la puntuación que los usuarios dan a una película?

Como se ha comentado anteriormente, se añadió al dataset la variable *“YearsSiceRelease”* con el objetivo de analizar si la diferencia entre el año de estreno de la película y el año de cuando esta se ha calificado influye en el número de estrellas o no. 
