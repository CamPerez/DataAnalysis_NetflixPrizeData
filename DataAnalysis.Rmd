...
aux=read_tsv("data/combined_data_1.txt",col_names=FALSE,n_max =300000)# leo 10^4 lo leo con tabulador para que lea una varable
...
aux_movie=read_csv("data/movie_titles.csv",col_names=FALSE,n_max =100)# leo 10^4 lo leo con tabulador para que lea una varable
