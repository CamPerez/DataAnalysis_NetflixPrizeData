...
Una vez se han exportado, leído y modelado los datos se procede a analizar y trabajar con ellos.
...
Realizamos el mismo estudio de la distribución de calificaciones pero teniendo en cuenta en esta ocasión los días de la semana. Para ello, se ha creado una nueva variable en el data set ***DayOfWeek*** que, dada la fecha de *RatingDate* con la función *weekdays* nos proporciona el día de la semana para día del calendario en concreto.
...
En este análisis se ha podido estudiar las diferentes valoraciones de los usuarios de *Netflix* de una muestra de 250 películas de la plataforma. Concretamente se ha podido analizar:
