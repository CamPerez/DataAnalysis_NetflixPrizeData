...
```{r  fig.cap='Número total de calificaciones por estrella.', fig.align="center", fig.width=7, fig.height=4}
...
```{r fig.cap='Porcentaje de calificaciones por mes.', fig.align="center", fig.width=7, fig.height=4}
...
set.seed(2495)
wordcloud2(movies_title, size = 0.39)
...
```{r fig.cap='Calificaciones por año de las películas más votadas.', fig.align="center", fig.width=7, fig.height=4}
...
```{r fig.cap='Calificación media por año y película.', message = FALSE, warning = FALSE, fig.align="center", fig.width=12, fig.height=8}
...
div(ggplotly(bar_plot_facet), align ="center")
...
```{r fig.cap='Comparativa estádistica de las 5 películas más votadas.', message = FALSE, warning = FALSE, fig.align="center", fig.width=7, fig.height=4}
...
div(ggplotly(boxplot), align ="center")
...
```{r fig.cap='Calificaciones según la diferencia entre años de estreno y de votación.', fig.align="center", fig.width=20, fig.height=4}
netflix %>%
